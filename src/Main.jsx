  ...
  return (
    ...
    className='Main' id="mainy">
      <div className="main_left">
        ...
        <h2 className='names'>MD JOUHAR PARVEZ</h2>
        <p className='i_am_a'>I am a&nbsp;<span class="typewriter"></span></p>
        
        <div className="flex1">
        <p className='follow_me'>follow me: </p>
        <div className="logos">
        <a href="https://www.codechef.com/users/jouhar123"><img src={codechef} alt="" /></a>
        <a href="https://github.com/Jouhar123" target="_blank" rel="noreferrer"><img src={github} alt=""  /></a>
        <a href="https://www.linkedin.com/in/md-jouhar-parvez/" target="_blank" rel="noreferrer"><img src={linked_in} alt=""></img></a>
        <a href="https://leetcode.com/u/Jouhar123/" target="_blank" rel="noreferrer"><img src={leetcodes} alt=""></img></a>
        </div>
        </div>
        <div className="flex1">
